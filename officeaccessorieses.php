...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12" align="center" style="background-color:#F1CF98">
			<h4 class="h4" style="color:Balck">Office Accessories</h4>
		</div>
	</div>
    ...
    <div  class="list-group list-group-horizontal">    
        ...
        $query = $db->query("SELECT * FROM `products` where products_category='Office Accessories' ORDER BY products_name LIMIT $limitStart ,30");
        if($query->num_rows > 0){ 
        ...
        <?php } 
			...
			<p class="lead" style="color:red"><b>Item Not Available</b></p>
        <?php } ?>
