...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12" align="center" style="background-color:#F1CF98">
			<h4 class="h4" style="color:Balck">Gift Corner</h4>
		</div>
	</div>
    ...
    <div  class="list-group list-group-horizontal">    
        ...
        $query = $db->query("SELECT * FROM `products` where products_category='Gift Item' ORDER BY products_name LIMIT $limitStart ,30");
        if($query->num_rows > 0){ 
