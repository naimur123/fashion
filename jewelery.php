...
<div class="container">
      <?php
        //get rows query
        $query = $db->query("SELECT name FROM category where cat_name='Jewelery Corner' ");
        if($query->num_rows > 0){ 
            while($row = $query->fetch_assoc()){
				// $s=$row['name'];
                // // echo $row['name'];
        ?>   
			<a href="jewelerys.php"><img src="admin/items/upload/<?php echo $row['name']; ?>"  class="img-responsive " style="width:100%; height: 164px"/></a>
			<br>
			&nbsp;
			&nbsp;
			&nbsp; <?php } }else{ ?>
        ...
        <?php } ?>
    <!-- <a href="jewelerys.php"><img src="./include/images/jewellery.png" style="width:100%; height:150px"></a>
    <br>
    &nbsp;
    &nbsp;
    &nbsp; -->
	...
	<div class="row">
		<div class="col-md-12" >
	    <h2 class="h4" style="font-family:Roboto; text-decoration: underline; text-decoration-color: #F1CF98; margin-left: -12px;"><b>Jewelery Corner<b></h2>
    ...
    <div  class="list-group list-group-horizontal">    
		<?php
        //get rows query
        $query = $db->query("SELECT * FROM products where products_category='Jewelery Corner' order by id DESC LIMIT 6");
        if($query->num_rows > 0){ 
            while($row = $query->fetch_assoc()){
        ?>
